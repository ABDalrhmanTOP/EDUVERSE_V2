...
const AdminDashboard = () => {
  ...
  const getAdminTitle = () => {
    return i18n.language === 'ar' ? 'إدارة إيديوفيرس' : 'EduVerse Admin';
  };
  ...
  return (
    <div className="admin-dashboard" dir={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
      {/* Sidebar */}
      <motion.div
      ...
      >
        <div className="admin-sidebar-header">
          <h2 className="admin-title">{getAdminTitle()}</h2>
        </div>
