...
class FinalTestQuestionController extends Controller
{
    ...
    {
        $query = FinalTestQuestion::query();
        if ($request->has('final_test_id')) {
            $query->where('final_test_id', $request->final_test_id);
        }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            'final_test_id' => 'required|exists:final_tests,id',
        ...
        $question = FinalTestQuestion::create($validated);
    ...
    {
        $question = FinalTestQuestion::findOrFail($id);
